...
Animal::Animal(double value, string name, string species,
...
void Animal::set_feedingRequirement(int newFeedingRequirement) {
  feedingRequirement = newFeedingRequirement;
}

int Animal::get_hungerRating() { return hungerRating; }
void Animal::set_hungerRating(int newHungerRating) {
  hungerRating = newHungerRating;
}

void Animal::feedAnimal() { this->hungerRating = 0; }
